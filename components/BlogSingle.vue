              ...
              <div class="sidebar__post-wrap">
                <div class="sidebar__post__single">
                  ...
                  <div class="sidebar__post-content">
                    ...
                    <h4 class="sidebar__post-title"><a href="/single-post">We design industry materials of innovation</a></h4>
                    <!-- /.sidebar__post-title -->
                ...
                <div class="sidebar__post__single">
                  ...
                  <div class="sidebar__post-content">
                    <span>20 Apr, 2020</span>
                    <h4 class="sidebar__post-title"><a href="/single-post">Pre launch Mobile App Marketing Pitfalls</a></h4>
                    <!-- /.sidebar__post-title -->
                  </div><!-- /.sidebar__post-content -->
                </div><!-- /.sidebar__post__single -->
